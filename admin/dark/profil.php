    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="<?= $_SESSION["user_sekil"] ?>" class="img-circle" width="150" />
                            <h4 class="card-title m-t-10"><?= $_SESSION["user_AdSoyad"] ?></h4>
                            <h6 class="card-subtitle"><?= $_SESSION["user_icaze"] == 1 ? "Admistrator" : "Moderator" ?></h6>
                        </center>
                    </div>
                    <div>
                        <hr>
                        ...
                        <div class="tab-pane active" id="settings" role="tabpanel">
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Köhnə Şifrə</label>
                                        <div class="col-md-12">
                                            <input type="password" value="password" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Yeni Şifrə</label>
                                        <div class="col-md-12">
                                            <input type="password"  id="yenisifre" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Yeni Şifrə Təkrar</label>
                                        <div class="col-md-12">
                                            <input type="password"  onkeyup="SifreTekrarYoxla()" id="yenisifretekrar" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
