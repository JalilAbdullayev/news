...
<!-- Mirrored from html.themewant.com/echo/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Sep 2023 17:23:23 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="echo-container">
            <div class="echo-error-content">
                <div class="echo-error">
                    ...
                    <div class="error-btn">
                        <a href="index.php" class="text-capitalize">go back home</a>
                    </div>
                </div>
            </div>
        </div>
